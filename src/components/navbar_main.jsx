        ...
        >
          <div class="flex place-items-end lg:items-center flex-col lg:flex-row">
            <a
              ...
              href="/"
              class=" {isClick ? 'block' : 'hidden'} block lg:mr-3 px-4 py-2 lg:py-2 text-white lg:bg-[#024428] lg:rounded-full hover:text-white hover:border-b-2  hover:border-gray-300 hover:bg-[#024428] hover:transition hover:ease-in-out delay-100 focus:bg-[#024428]"
            >
              Beranda
            </a>
            <a
